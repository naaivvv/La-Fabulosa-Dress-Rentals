...
<head>
    <title> Employee Signup | La Fabulosa Dress Rentals  </title>
</head>
...
<body>
     ...
     <nav class="navbar navbar-custom navbar-fixed-top" role="navigation" style="color: black">
        <div class="container">
            <div class="navbar-header">
                ...
                La Fabulosa Dress Rental Rentals </a>
            </div>
    ...
    <div class="container">
        <div class="jumbotron">
            <h1 class="text-center">La Fabulosa Dress Rentals <br> Registration</h1>
            <br>
    ...
    <div class="container" style="margin-top: -1%; margin-bottom: 2%;">
        <div class="col-md-5 col-md-offset-4">
            <div class="panel panel-primary">
                <div class="panel-heading pink-component"> Create Account </div>
                        ...
                        <div class="row">
                            <div class="form-group col-xs-12">
                                ...
                                <div class="input-group">
                                    ...
                                    <span class="input-group-btn">
                  <label class="btn pink-component"><span class="glyphicon glyphicon-envelope" aria-hidden="true"></label>
              </span>
                                    </span>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="form-group col-xs-12">
                                ...
                                <div class="input-group">
                                    ...
                                    <span class="input-group-btn">
                  <label class="btn pink-component"><span class="glyphicon glyphicon-contact" aria-hidden="true"></span></label>
                                    </span>
                        ...
                        <div class="row">
                            <div class="form-group col-xs-12">
                                ...
                                <div class="input-group">
                                    ...
                                    <span class="input-group-btn">
                  <label class="btn pink-component"><span class="glyphicon glyphicon-home" aria-hidden="true"></label>
              </span>
                                    </span>
                                </div>
                            </div>
                  ...
                  <label class="btn pink-component"><span class="glyphicon glyphicon-lock" aria-hidden="true"></span></label>
                        ...
                        <div class="row">
                            <div class="form-group col-xs-4">
                                <button class="btn pink-component" type="submit">Submit</button>
                            </div>
