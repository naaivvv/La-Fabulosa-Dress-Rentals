...
$sql1 = "SELECT d.dress_name, rd.id, rd.rent_start_date, rd.rent_end_date, rd.charge_type, rd.dress_price, rd.no_of_days, rd.total_amount
         FROM renteddresses rd
         JOIN dresses d ON d.dress_id = rd.dress_id WHERE rd.decision = 'Pending'";
...
<div class="container">
    <div class="jumbotron">
        <h1 class="text-center">Pending Rentals</h1>
        <p class="text-center">Determine each dress rent request.</p>
    </div>
</div>
<div class="row text-center">
    <div class="col-md-12 offset-md-3">
        <form class="form-inline my-2 my-lg-0" onsubmit="return searchRentals()">
            <input class="form-control mr-sm-2" type="text" id="rentalSearch" placeholder="Search by dress name">
    ...
    <table class="table table-striped">
        ...
        ?>
            <tr>
                ...
                <td><a href="approvedress.php?id=<?php echo $row["id"]; ?>">Approve</a> | <a href="rejectdress.php?id=<?php echo $row["id"]; ?>">Reject</a></td>
            </tr>
        <?php        } ?>
    </table>
</div>
...
<div class="container">
    <div class="jumbotron">
        ...
        <p>Invite customers now<?php echo $conn->error; ?> </p>
    </div>
</div>
<?php
} ?>
 ...
 <script>
    function searchRentals() {
        ...
        input = document.getElementById("rentalSearch");
