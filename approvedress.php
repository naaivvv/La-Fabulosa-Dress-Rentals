...
<div class="container" style="margin-top: 65px;">
    <div class="col-md-7" style="float: none; margin: 0 auto;">
        <div class="form-area">
            <form role="form" action="approve.php?id=<?php echo $id ?>" method="POST">
                <br style="clear: both">
                <h3 style="margin-bottom: 5px; text-align: center; font-size: 30px;"> Dress Details </h3>
                <h6 style="margin-bottom: 25px; text-align: center; font-size: 12px;"> Review the details below before clicking Approve. </h6>
                ...
                <input type="submit" name="submit" value="Approve" class="btn btn-success pull-right">
            </form>
        </div>
    </div>
</div>
