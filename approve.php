...
<!-- Navigation -->
    ...
    <?php
        ...
        if ($result1) {
            ...
            $sql2 = "UPDATE dresses d, renteddresses rd SET rd.decision='Approved' WHERE rd.dress_id=d.dress_id AND rd.id = '$id'";
        ...
        <div class="container">
            <div class="jumbotron">
                <h1 class="text-center" style="color: green;"><span class="glyphicon glyphicon-ok-circle"></span> Dress Approved</h1>
            </div>
        </div>
        <br>

        <h2 class="text-center"> Please process the dress rental.</h2>

        <h3 class="text-center"> <strong>Your Order Number:</strong> <span style="color: blue;"><?php echo "$id"; ?></span> </h3>

        <div class="container">
    <h5 class="text-center">Information about the order.</h5>
    <div class="box">
            <div class="col-md-10" style="float: none; margin: 0 auto; text-align: center;">
                <h3 style="color: orange;">The booking has been received and placed into out order processing system.</h3>
                <br>
                <h4>Please make a note of the <strong>order number</strong> now and keep in the event we need to communicate with the customer about the order.</h4>
                <br>
