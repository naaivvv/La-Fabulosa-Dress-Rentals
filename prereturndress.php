...
$sql1 = "SELECT d.dress_name, rd.id, rd.rent_start_date, rd.rent_end_date, rd.charge_type, rd.dress_price, rd.no_of_days, rd.total_amount FROM renteddresses rd, dresses d
    WHERE d.dress_id=rd.dress_id AND rd.return_status='NR' AND rd.decision='Approved'";
...
?>
    <div class="container">
        <div class="jumbotron">
            <h1 class="text-center">Return your dresses here</h1>
    ...
    <div class="row text-center">
        <div class="col-md-12 offset-md-3">
            <form class="form-inline my-2 my-lg-0" onsubmit="return searchDresses()">
                <input class="form-control mr-sm-2" type="text" id="dressSearch" placeholder="Search by dress name">
        ...
        <table class="table table-striped">
            ...
            ?>
                <tr>
                    ...
                    <td><a href="returndress.php?id=<?php echo $row["id"]; ?>"> Return </a></td>
                </tr>
            <?php        } ?>
        </table>
    </div>
...
?>
    <div class="container">
        <div class="jumbotron">
            <h1 class="text-center">No dresses to return.</h1>
            <p class="text-center"> Hope you enjoyed our service </p>
        </div>
    </div>
<?php
...
<script>
    function searchDresses() {
        ...
        input = document.getElementById("dressSearch");
