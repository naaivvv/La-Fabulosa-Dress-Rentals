...
// Retrieve client details based on client_username
$sql = "SELECT * FROM clients WHERE client_username = '$client_username'";
$result = $conn->query($sql);

if(mysqli_num_rows($result) == 1) {
    $row = mysqli_fetch_assoc($result);

    // Pre-fill form fields with client details
    ...
    // Handle the case where no client is found with the given client_username
...
<div class="col-md-7" style="float: none; margin: 0 auto;">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="client_name" name="client_name" placeholder="Full Name" required value="<?php echo $client_name; ?>">
        </div>

        <div class="form-group">
            <label for="client_phone">Phone Number</label>
            <input type="text" class="form-control" id="client_phone" name="client_phone" placeholder="Phone Number" required value="<?php echo $client_phone; ?>">
        </div>

        <div class="form-group">
            <label for="client_email">Email Address</label>
            <input type="email" class="form-control" id="client_email" name="client_email" placeholder="Email Address" required value="<?php echo $client_email; ?>">
        </div>

        <div class="form-group">
            <label for="client_address">Address</label>
            <input type="text" class="form-control" id="client_address" name="client_address" placeholder="Address" required value="<?php echo $client_address; ?>">
        </div>
