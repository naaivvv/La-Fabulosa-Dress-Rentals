...
<!-- Navigation -->
    ...
    <?php
        ...
        if ($result1) {
            ...
            $sql2 = "UPDATE dresses d, renteddresses rd SET d.dress_availability='yes' WHERE rd.dress_id=d.dress_id AND rd.id = '$id'";
        ...
        <div class="container">
            <div class="jumbotron">
                <h1 class="text-center" style="color: green;"><span class="glyphicon glyphicon-ok-circle"></span> Dress Returned</h1>
            </div>
        </div>
        <br>
